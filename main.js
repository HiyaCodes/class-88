...
function up(){
   if(player_y>=0){
    ...
    console.log ("when up arrow is pressed,X="+ player_x)
...
function down(){
    if(player_y<=400){
     player_y=player_y+block_image_height
     console.log ("block_image_height="+block_image_height)
     console.log ("when down arrow is pressed,X="+ player_x)
...
function right(){
    if(player_x<=900){
     ...
     console.log ("when right arrow is pressed,Y="+ player_y)
     canvas.remove(player_object)
     player_update()
    }
}
function left(){
    if(player_x>=0){
     ...
     console.log ("when left arrow is pressed,Y="+ player_y)
     canvas.remove(player_object)
     player_update()
    }
}